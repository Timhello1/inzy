...
class DigitSubMedium : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_digit_sub_medium)
        ...
        if (recyclerView1 != null && recyclerView2 != null && randomDigitsTextView != null  && translationEditText != null && checkButton != null) {
            ...
            val randomDigits = (0 until 20).map { Random.nextInt(10) }.joinToString(" ")
            ...
            checkButton.setOnClickListener {
                ...
                if (userInput.length == 20) {
                    ...
                    if (inputIndices.all { it != -1 }) {
                        ...
                        Toast.makeText(this, "Błąd. Podaj tylko 20 liter znajdujących się w słowniku.", Toast.LENGTH_SHORT).show()
                    }
                } else {
                    // Display an error message for input length other than 10
                    Toast.makeText(this, "Podaj tylko 20 liter, podane zostało: " + userInput.length.toString(), Toast.LENGTH_SHORT).show()
                }
            }
    ...
    private fun saveScore(){
        ...
        val scoresCollection = firestore.collection("DigitalSub20")
