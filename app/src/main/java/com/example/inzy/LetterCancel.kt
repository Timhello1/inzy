...
class LetterCancel : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_letter_cancel)
        ...
        while (letterList.count { it == targetLetter } < 5) {
    ...
    private fun saveScore(){
        ...
        val scoresCollection = firestore.collection("LetterCancel5Score")
