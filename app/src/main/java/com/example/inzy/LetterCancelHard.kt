...
class LetterCancelHard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_letter_cancel_hard)
        ...
        while (letterList.count { it == targetLetter } < 10) {
    ...
    private fun saveScore(){
        ...
        val scoresCollection = firestore.collection("LetterCancel10Score")
